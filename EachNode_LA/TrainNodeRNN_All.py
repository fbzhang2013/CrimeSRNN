...
#    model.add(Dropout(0.2))
    ...
    with open("Saved_models/model{0}.json".format(train_n), "w") as json_file:
        json_file.write(model_json)
    # serialize weights to HDF5
    model.save_weights("Saved_models/model{0}.h5".format(train_n))
...
if __name__ == '__main__':
    for n_index in [2,4,5,6,7,8,9,10,11]:
        train_n = n_index
        ndays = 730
        TimeEachDay = 24
        ...
        print 'Begin Training node ', train_n
