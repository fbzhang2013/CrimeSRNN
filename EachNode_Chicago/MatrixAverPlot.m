TrainType3_TestType1 = load(fullfile(pwd,'Results_Matrix_Aver','AnoAcc_TrainType1_TestType1.csv'));
TrainType3_TestType2 = load(fullfile(pwd,'Results_Matrix_Aver','AnoAcc_TrainType1_TestType2.csv'));
TrainType3_TestType3 = load(fullfile(pwd,'Results_Matrix_Aver','AnoAcc_TrainType1_TestType3.csv'));
